...
export class ExternalSource {
   ...
   */
  getDimensionInfo(dim: DimensionLoose): ExternalDimensionDefinition | undefined {
    return;
  }
   ...
   */
  cloneAllDimensionInfo(): ExternalDimensionDefinition[] | undefined {
    return;
  }
   ...
   */
  retrieveValue(dataIndex: number, dimIndex: DimensionIndex): OptionDataValue | undefined {
    return;
  }

  retrieveValueFromItem(dataItem: DataTransformDataItem, dimIndex: DimensionIndex): OptionDataValue | undefined {
    return;
  }

  convertValue(rawVal: unknown, dimInfo: ExternalDimensionDefinition): ParsedValue | undefined {
