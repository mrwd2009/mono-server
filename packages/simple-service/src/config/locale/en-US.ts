const locale = {
  translation: {
    ...
    auth: {
      ...
      lockedMessage_one:
        'Your account has been locked, please wait {{count}} minute to unlock or click link in your inbox to unlock.',
      lockedMessage_other:
        'Your account has been locked, please wait {{count}} minutes to unlock or click link in your inbox to unlock.',
