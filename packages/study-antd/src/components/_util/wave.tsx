...
import { updateCSS } from '../../dependents/util/src/Dom/dynamicCSS';
import { supportRef, composeRef } from '../../dependents/util/src/ref';
import raf from './raf';
...
export default class Wave extends React.Component<WaveProps> {
  ...
  onClick = (node: HTMLElement, waveColor: string) => {
    ...
    ['transition', 'animation'].forEach(name => {
      node.addEventListener(`${name}start`, this.onTransitionStart as any);
      node.addEventListener(`${name}end`, this.onTransitionEnd as any);
    });
  }
  ...
  resetEffect(node: HTMLElement) {
    ...
    ['transition', 'animation'].forEach(name => {
      node.removeEventListener(`${name}start`, this.onTransitionStart as any);
      node.removeEventListener(`${name}end`, this.onTransitionEnd as any);
    });
  }
